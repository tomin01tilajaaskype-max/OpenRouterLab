...
# Voit vaihtaa branchin myöhemmin, jos tarvitsemme tietyn version.
...
# Lisätään mahdolliset omat feedit vain, jos tiedosto löytyy.
...
# Etsitään laitekohtainen config ensin profile-nimellä, sitten yleinen config.
...
echo
echo "Stopping here so we do not build firmware for the wrong device."
exit 1
fi

# Overlay on vapaaehtoinen.
