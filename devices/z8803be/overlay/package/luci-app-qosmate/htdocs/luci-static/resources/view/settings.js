...
function fetchVersionInfo() {
    versionInfo = {
        backend: { current: '0.5.48', latest: '0.5.48', channel: 'firmware' },
        frontend: { current: '1.2.0', latest: '1.2.0', channel: 'firmware' }
    };
...
return view.extend({
    ...
    render: function() {
        ...
        s_info = m.section(form.NamedSection, 'global', 'global', _('Firmware Version'));
