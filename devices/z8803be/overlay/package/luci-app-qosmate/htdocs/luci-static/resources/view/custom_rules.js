...
function validationHtml(value) {
    return '<div class="cbi-section-node" style="margin-top: 8px; min-width: 700px;">' +
...
${formvalue.trim()}
        ...
        o.default = validationResult
            ? validationHtml(validationResult)
            ...
            return fs.write('/etc/qosmate.d/custom_rules.nft', fullCustomContent)
                ...
                .then((result) => {
                    ...
                    if (validationResultElement) {
                        validationResultElement.innerHTML = validationHtml(result);
                    }
